...
const MOCK_GOALS = [
  {
    ...
    current: 85000000,
    deadline: '2024-12-31',
    message: 'Help me renew my rent in January!',
  },
];
          ...
          <Animated.View entering={FadeInDown.delay(150).duration(500)} className="mx-5 mb-5">
            <View
              ...
              <Button
                ...
                <ButtonText className="text-xs text-white" style={{ fontFamily: 'Geist_700Bold' }}>
                  Renew
                </ButtonText>
              </Button>
            </View>
            ...
            <Animated.View entering={FadeInDown.duration(400)} className="gap-3">
              {MOCK_PAYMENTS.map((payment) => (
                <View
                  ...
                  <Text className="text-sm text-[#0E7C7B]" style={{ fontFamily: 'Geist_700Bold' }}>
