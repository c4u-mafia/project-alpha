    ...
    <KeyboardAvoidingView
      ...
      <View className="flex-1 px-6 pb-10 pt-14">
        ...
        <Animated.View entering={FadeInDown.delay(100).duration(600)} className="mb-10">
          <View className="mb-5 h-14 w-14 items-center justify-center rounded-2xl bg-mint">
          ...
          <Text
            className="text-[15px] leading-6 text-charcoal/50"
            style={{ fontFamily: 'Geist_400Regular' }}>
            We sent a 6-digit code to{'\n'}
            <Text className="text-charcoal" style={{ fontFamily: 'Geist_600SemiBold' }}>
              {email}
            </Text>
          </Text>
        </Animated.View>
        ...
        <Animated.View entering={FadeIn.delay(500).duration(600)} className="mt-8 items-center">
          <Text
            className="mb-1 text-sm text-charcoal/40"
            style={{ fontFamily: 'Geist_400Regular' }}>
            {"Didn't get the code?"}
          </Text>
