...
export class CreateRentGoalDto {
  ...
  @ApiProperty({ example: '2026-09-01T00:00:00Z', description: 'Deadline ISO timestamp' })
  @IsString()
  deadline: string;
...
export class ContributeDto {
  ...
  @ApiPropertyOptional({ example: 'John Doe', description: 'Required for guest sponsors' })
  @IsOptional()
  @IsString()
  sponsorName?: string;

  @ApiPropertyOptional({ example: 'john@example.com', description: 'Required for guest sponsors' })
  @IsOptional()
  @IsEmail()
  sponsorEmail?: string;
